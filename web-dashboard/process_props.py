...
def process_props(input_path, output_dir):
    print(f"Processing props: {input_path}")
    ...
    # Identify columns that have visible pixels
    ...
    # Group contiguous True columns into chunks
    chunks = [] # list of (start_x, end_x)
    in_chunk = False
    start_x = 0
    for x in range(width):
    ...
    for i, (start_x, end_x) in enumerate(chunks):
        ...
        # Find tight vertical bounds inside this chunk
...
input_img = "/Users/alan_wang/.gemini/antigravity/brain/800943fc-9f00-4bad-9a71-41e2c452d54c/pixel_props_spritesheet_1771904430535.png"
out_dir = "/Users/alan_wang/project-golem/web-dashboard/public/props"
os.makedirs(out_dir, exist_ok=True)
process_props(input_img, out_dir)
